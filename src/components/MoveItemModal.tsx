        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
                ...
                <button
                  ...
                  className={`py-2 text-xs font-semibold rounded-lg border flex items-center justify-center gap-1.5 transition-all cursor-pointer ${
                    destinationType === "shelf"
                      ...
                      : "bg-slate-50 text-slate-600 border-stone-200"
                  }`}
                >
          ...
          {destinationType === "shelf" || item.type !== "File" ? (
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 bg-slate-50 border border-stone-200 rounded-lg text-xs text-stone-900 focus:outline-none focus:ring-2 focus:ring-amber-500"
              >
                {shelves.map((s) => (
          ...
          <div className="pt-3 border-t border-slate-200 flex justify-end gap-2">
            <button
              type="button"
              onClick={onClose}
              className="px-3.5 py-2 bg-slate-100 hover:bg-slate-200 text-stone-700 text-xs font-semibold rounded-xl cursor-pointer"
            >
              Cancel
            </button>
            <button
