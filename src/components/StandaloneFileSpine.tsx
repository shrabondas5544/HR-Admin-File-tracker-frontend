...
export const StandaloneFileSpine: React.FC<StandaloneFileSpineProps> = ({
  ...
  return (
    ...
    >
      <div className="w-full bg-amber-500 text-slate-950 text-[7px] font-mono font-bold py-0.5 rounded-t text-center truncate">
        {file.code.slice(-5)}
      </div>

      <div className="flex-1 flex items-center justify-center overflow-hidden py-1">
        <span
          className="text-[9px] font-semibold text-slate-800 tracking-wider whitespace-nowrap truncate"
          style={{
      ...
      <div className="flex items-center justify-center pb-0.5 text-slate-500">
        {file.attachmentUrl ? (
      ...
      <div className="absolute -top-7 left-1/2 -translate-x-1/2 hidden group-hover:flex items-center gap-1 bg-white border border-slate-300 px-1 py-0.5 rounded shadow-lg z-40">
        <button
          onClick={onMove}
          title="Move File"
          className="p-0.5 text-slate-500 hover:text-amber-600 transition-colors"
        >
        ...
        <button
          ...
          className="p-0.5 text-slate-500 hover:text-red-600 transition-colors"
        >
